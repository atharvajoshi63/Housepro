...
int bno=0,bno1=0,wphno=0;
String	f_name="",l_name="",cat="",wfname="",wlname="",code="";
...
<td><b><%=f_name%> </b></td></tr> <%
	...
	<b><tr align= center><th></th></tr></b></font>    
		...
		<tr>
		<td> </td>
		<tr align=right><td><b>TOTAL:</b></td><td bgcolor="white"><b><%="Rs."+total%></b></td><td>(.including taxes*)</td>
		</tr>
		
		<% 
 cat=code;
   String sql3="select * from profession where specialization='"+cat+"'";
	ResultSet rs1=st.executeQuery(sql3);
	while(rs1.next())
	{
	        wfname=rs1.getString(2);
	        wlname=rs1.getString(3);
	        wphno=rs1.getInt(5);
		
	
%>

<tr align="center"><td>Service will held by our following expertise</td></tr>
<tr align="center"><td><b><%=wfname%> <%=wlname%></b></td></tr>
<tr align="center"><td><b>Contact: <%=wphno%> </b></td></tr>
</table>
 <%
