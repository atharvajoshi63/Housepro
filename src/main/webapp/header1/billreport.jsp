...
<link rel="stylesheet" type="text/css" href="billreport.css">
            ...
            <li><a href="adminhome.jsp">Home</a></li>
                ...
                <li><a href="professionalfield.jsp">Professional Field</a></li>
                 <li><a href="signupreport.jsp">Customer Details</a></li>
                  ...
                  <li class="active"><a href="billreport.jsp">Bill Details</a><li>
...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3325/housepro","root","");
Statement st=con.createStatement();
PreparedStatement ps=con.prepareStatement("Select * from bill");

ResultSet rs=ps.executeQuery();
%><label>Bill-Details Of User</label><% 
while(rs.next()){
				%>
				<tr>
